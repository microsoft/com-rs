...
//     // let iunknown_impl = gen_iunknown_impl(&interface_idents, &class_factory_ident);
...
//     let release = gen_release(interface_idents, class_factory_ident);
//     quote! {
...
// pub fn gen_release(interface_idents: &[syn::Path], struct_ident: &Ident) -> HelperTokenStream {
...
//     let release_drops = super::iunknown_impl::gen_release_drops(interface_idents, struct_ident);
